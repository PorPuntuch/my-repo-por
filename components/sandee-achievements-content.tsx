...
import { BookOpen, Clock, Target, Trophy, Star, Calendar } from "lucide-react"
  ...
  return (
    <div className="pb-20 px-6 space-y-6 max-w-2xl mx-auto">
      ...
      <div className="text-center pt-4">
        ...
        <p className="text-gray-600">Celebrate your reading journey and milestones</p>
      </div>
      ...
      <div>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-xl font-semibold text-gray-900">Achievements Unlocked</h2>
        </div>
          ...
          {mockCompletedBooks.map((book) => (
            <Card key={book.id} className="bg-white">
              <CardContent className="p-6">
                ...
                <div className="border-l-3 border-[#4CAF50] pl-4">
